package WaterPowerPlant
  ...
  <tr><td style=\"text-align: center;\">Miscellaneous</td>
  <td><ul><li>ElectricalLoad</li><li>Pipe</li><li>Pipe_with_lambda</li><li>Environment</li></ul></td>
  </tr>
  
  </tbody></table>
  Other Components in the Package are:
    
  <div><ul><li>Environment</li><li>Pipe</li><li>Pipe considering Lambda</li><li>Electrical Load</li></ul></div></body></html>"));
    end Overview;
  ...
  package Interfaces
    connector RotationalPort
      ...
      annotation(
        ...
        Documentation(info = "<html><head></head><body>A simple port for connecting components.<div><br></div><div><ul><li>Effort Variable: Angular Velocity</li><li>Flow Variable: Torque</li></ul></div></body></html>"));
    end RotationalPort;
    ...
    connector ElectricalPort
      ...
      annotation(
        ...
        Documentation(info = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">A simple port for connecting components.</span><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><br></div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><ul><li>Effort Variable: Voltage</li><li>Flow Variable: Current</li></ul></div></body></html>"));
    end ElectricalPort;
    ...
    connector FluidPort
      ...
      annotation(
        ...
        Documentation(info = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">A simple port for connecting components.</span><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><br></div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><ul><li>Effort Variable: Pressure</li><li>Flow Variable: Mass flow rate</li></ul></div></body></html>"));
    end FluidPort;
    annotation(
      ...
      Documentation(info = "<html><head></head><body>Collection of Ports/Interfaces</body></html>"));
  end Interfaces;
  ...
  package Examples
    ...
    protected
      annotation(
        ...
        Documentation(info = "<html><head></head><body>A simple example to showcase the behavior of a flow between two tanks and a basic turbine.</body></html>"));
    end TankTurbine;
    ...
    model Generator_synchron_3Phases
      ...
      WaterPowerPlant.Components.ElectricalLoad electricalLoad annotation(
        Placement(visible = true, transformation(origin = {61, -69}, extent = {{25, 25}, {-25, -25}}, rotation = 180)));
      WaterPowerPlant.Components.Turbines.Turbine_advanced turbine_advanced annotation(
        Placement(visible = true, transformation(origin = {-47, 7}, extent = {{-19, -19}, {19, 19}}, rotation = 0)));
      WaterPowerPlant.Components.ElectricalLoad electricalLoad1 annotation(
        Placement(visible = true, transformation(origin = {73, -59}, extent = {{25, 25}, {-25, -25}}, rotation = 180)));
      WaterPowerPlant.Components.ElectricalLoad electricalLoad11 annotation(
    ...
    equation
      connect(openTank.fluidPort, turbine_advanced.fluidPort_in) annotation(
        Line(points = {{-75.23, 53.13}, {-61.23, 53.13}, {-61.23, 17.13}}));
      connect(turbine_advanced.fluidPort_out, openTank1.fluidPort) annotation(
        Line(points = {{-31.99, -4.97}, {-30.99, -4.97}, {-30.99, -55.97}}));
      connect(turbine_advanced.rotationalPort_out, generator_Synchron_3Phases.rotationalPort_in) annotation(
        Line(points = {{-30, 8}, {0, 8}, {0, 24}}));
      connect(generator_Synchron_3Phases.electricalPort_out3, electricalLoad.electricalPort_in) annotation(
        Line(points = {{40, 18}, {46, 18}, {46, -54}}));
      connect(generator_Synchron_3Phases.electricalPort_out2, electricalLoad1.electricalPort_in) annotation(
        Line(points = {{40, 24}, {58, 24}, {58, -44}}));
      connect(generator_Synchron_3Phases.electricalPort_out1, electricalLoad11.electricalPort_in) annotation(
        Line(points = {{40, 28}, {70, 28}, {70, -34}}));
    protected
      annotation(
        Diagram,
        Icon(graphics = {Polygon(lineColor = {78, 138, 73}, fillColor = {255, 170, 0}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, points = {{-36, 60}, {64, 0}, {-36, -60}, {-36, 60}}), Ellipse(extent = {{-100, 100}, {100, -100}})}),
        Documentation(info = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">An example with complete chain of effects. Needed to test the 3 Phases Synchron Machine.</span></body></html>"));
    ...
    equation
      connect(openTank1.fluidPort, turbine_advanced.fluidPort_out) annotation(
        Line(points = {{37, -84}, {-7, -84}, {-7, -29}}));
      connect(turbine_advanced.fluidPort_in, openTank.fluidPort) annotation(
        Line(points = {{-42, -2}, {-62, -2}, {-62, 35}}));
      connect(turbine_advanced.rotationalPort_out, generator_basic.rotationalPort_in) annotation(
        Line(points = {{-4, -15}, {-13.8, -15}, {-13.8, 53}, {19, 53}}));
      connect(generator_basic.electricalPort_out, electricalLoad.electricalPort_in) annotation(
      ...
      annotation(
        ...
        Documentation(info = "<html><head></head><body>An example with complete chain of effects. Needed to test Generators and advanced turbines.<!--EndFragment--></body></html>"));
    ...
    equation
      ...
      annotation(
        Icon(graphics = {Polygon(lineColor = {78, 138, 73}, fillColor = {78, 138, 73}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, points = {{-36, 60}, {64, 0}, {-36, -60}, {-36, 60}}), Ellipse(extent = {{-100, 100}, {100, -100}})}),
        Documentation(info = "<html><head></head><body>Not yet working digital twin of the powerplant Säckingen.</body></html>"));
    ...
    model Example_KraftwerkSaeckingen_simple
      ...
      WaterPowerPlant.Components.Turbines.Turbine_Francis turbine_Francis(n_turbine = 10, radius = 1.036) annotation(
        Placement(visible = true, transformation(origin = {-14, 4}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
      WaterPowerPlant.Components.Generators.Generator_Synchron generator_Synchron(R_e = 0.005,U0(displayUnit = "kV") = 235000, X_d = 2, cos_phi = 0.76, theta(displayUnit = "rad") ) annotation(
        Placement(visible = true, transformation(origin = {42, 4}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
      WaterPowerPlant.Components.ElectricalLoad electricalLoad annotation(
        Placement(visible = true, transformation(origin = {82, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      WaterPowerPlant.Components.Tanks.OpenTank lower_reservoir(A = 1000000000, Nozzle = 5.8, altitude = 300, levelInitial = 0) annotation(
      ...
      Components.Pipe pipe2(d = 5.8,h_in = 300, h_out = 300, l = 2000) annotation(
    ...
    equation
      connect(generator_Synchron.rotationalPort_in, turbine_Francis.rotationalPort_out) annotation(
        Line(points = {{28, 8}, {12.5, 8}, {12.5, 4}, {1, 4}}));
      connect(electricalLoad.electricalPort_in, generator_Synchron.electricalPort_out) annotation(
        Line(points = {{76, 8}, {52, 8}}));
      ...
      connect(pipe1.fluidPort_out, turbine_Francis.fluidPort_in) annotation(
        Line(points = {{-34, 24}, {-34, 16.5}, {-26, 16.5}, {-26, 13}}));
    ...
    annotation(
      ...
      Documentation(info = "<html><head></head><body>A collection of examples to illustrate the usage of this modelica library.&nbsp;<div><br></div></body></html>"));
  end Examples;
  ...
  package Components
    ...
    //Sink should absorb all inflow
      ...
      annotation(
        ...
        Documentation(info = "<html><head></head><body><table border=\"1\" cellspacing=\"0\" cellpadding=\"1\" style=\"font-family: 'MS Shell Dlg 2';\"><tbody><tr><td><strong>Name</strong></td><td><b>Connector</b></td><td><b>Usecase</b></td><td><strong>Link</strong></td></tr><tr><td><strong>OpenTank</strong></td><td>FluidPort</td><td>Showcase of hydrostatic force and lowering water leves.</td><td><a href=\"modelica:///WaterPowerPlant.Components.Turbines.Turbine_basic\">WaterPowerPlant.Components<u>.Tanks.OpenTank</u></a></td></tr><tr><td><b>OpenTankSimple</b></td><td>FluidPort</td><td>Showcase of dependency on environment in combination with lowering water leves.</td><td><a href=\"modelica:///WaterPowerPlant.Components.Turbines.Turbine_advanced\">WaterPowerPlant.Components.<u>Tanks.OpenTankSimple</u></a></td></tr><tr><td><b>Sink</b></td><td>FluidPort</td><td>Showcase of simple Sink&nbsp;</td><td><a href=\"modelica:///WaterPowerPlant.Components.Turbines.Turbine_Pelton\">WaterPowerPlant.Components.<u>Tanks.Sink</u></a></td></tr></tbody></table></body></html>"));
    end Tanks;
  ...
  // fluidPort_out
        ...
        annotation(
          ...
          Documentation(info = "<html><head></head><body>Turbine model taking into account the degree of efficiency.<div>Transforms the pressure into the virtual fall height of the fluid.</div><div>The resulting power of the turbine is calculated via a&nbsp;Turbine equation.</div><div><br></div><div>The basic turbine is a simple Model of an turbine transforming incoming mass flow and applied pressure into power.<div>It provides two FluidPort connectors for inflow and outflow.</div><div><div>Possible&nbsp;<b>Parameters</b>&nbsp;influencing the resulting power are:</div><div><ul><li>eta as degree of efficiency (between 0 and 1)</li></ul></div></div></div></body></html>"));
      end Turbine_basic;
  
      model Turbine_advanced
        // Connectors
        WaterPowerPlant.Interfaces.FluidPort fluidPort_in annotation(
          Placement(visible = true, transformation(origin = {-92, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-74, 56}, extent = {{-32, -32}, {32, 32}}, rotation = 0)));
        WaterPowerPlant.Interfaces.FluidPort fluidPort_out annotation(
  ...
  // rotationalPort_out
        ...
        annotation(
          ...
          Documentation(info = "<html><head></head><body>Turbine model taking into account the degree of efficiency.<div>Transforms the pressure into the virtual fall height of the fluid.</div><div>The resulting power of the turbine is calculated via a&nbsp;Turbine equation.</div><div><br></div><div>The advanced turbine is a simple Model of an turbine transforming incoming mass flow and applied pressure into mechanical power.<div>It provides two FluidPort connectors for inflow and outflow.&nbsp;</div><div>Additionally it provides a RotationalPort to transfer the mechanical power to a generator.</div><div><div>Possible&nbsp;<b>Parameters</b>&nbsp;influencing the resulting power are:</div><div><ul><li>eta as degree of efficiency (between 0 and 1)</li><li>f0 as the desired frequency of the output.</li></ul></div></div></div></body></html>"));
      end Turbine_advanced;
  ...
  // fluidPort_out
        ...
        annotation(
          ...
          Documentation(info = "<html><head></head><body>Model of a Pelton Turbine displaying the behaivior under normal conditions.<div>This model does not include simulations for startup or shutdown phases.<br><div><br></div><div>Transforms the pressure into the virtual fall height of the fluid. The potential energy is transformed into kinetic energy (through the Nozzle).</div><div>The blades of the turbine direct the water in an U-formed arc back, which serves as 2 force impacts and prepell the blades forward.&nbsp;</div><div>The efficiency of this operation is described by the parameters F_1 (first impact) and F_2 (second impact).</div><div>The optimum velocity of the blades is dependent on the kinetic energy of the water.&nbsp;</div><div><br></div><div>Possible&nbsp;<b>Parameters</b>&nbsp;influencing the resulting mechanical power are:</div><div><ul><li>F_1 as degree of efficiency for the first force impact (between 0 and 1)</li><li>F_2 as degree of efficiency for the second force impact (between 0 and 1)</li><li>radius of the turbine</li><li>Nozzle_Area of the nozzle used to transform the potential into kinetic&nbsp;Energy</li></ul></div></div></body></html>"));
      end Turbine_Pelton;
  ...
  // fluidPort_out
        ...
        annotation(
          ...
          Documentation(info = "<html><head></head><body>Model of a Francis Turbine displaying the behaivior under normal conditions.<div><div><br></div><div>Transforms the pressure into the virtual fall height of the fluid.&nbsp;</div><div>Calculates the resulting mechanical power through the&nbsp;Turbine equation used in 'Turbine_basic' and 'Turbine_advanced'.</div><div>The transformation of power to torque has been done on the basis of DI&nbsp;<span style=\"font-family: sans-serif; font-size: calc(var(--scale-factor) * 12px);\">Dr. techn. Klaus LEEB from HTBL Wien. <a href=\"http://www.math-tech.at/Beispiele/upload/leeb_Francis-Turbine.pdf\"> link</a></span></div><!--StartFragment--><!--EndFragment--><div><br></div><div>Possible&nbsp;<b>Parameters</b>&nbsp;influencing the resulting mechanical power are:</div><div><ul><li>eta_turbine as degree of efficiency for the turbine (between 0 and 1)</li><li>radius of the turbine (Center - Inner perimeter)</li><li>n_turbine as the desired working frequency of the turbine</li></ul></div></div></body></html>"));
      end Turbine_Francis;
      annotation(
        ...
        Documentation(info = "<html><head></head><body><div><b>Waterplant.Components.'Turbines'</b></div>This Sublibrary contains the different Turbines which have been modeled for various usecases:<div><br><div><table border=\"1\" cellspacing=\"0\" cellpadding=\"1\"><tbody><tr><td><strong>Name</strong></td><td><b>Connectors</b></td><td><b>Usecase</b></td><td><strong>Link</strong></td></tr><tr><td><strong>Turbine_basic<br></strong></td></blockquote></td><td>FluidPort</td><td>Showcase of transformation of Pressure and Massflow to mechanical/electrical Power dependeding on the degree of efficiency</td><td><a href=\"modelica://WaterPowerPlant.Components.Turbines.Turbine_basic\">WaterPowerPlant.Components.Turbines.Turbine_basic</a></td></tr><tr><td><b>Turbine_advanced</b></td><td>FluidPort, RotationalPort</td><td>Showcase of transformation of Pressure and Massflow to mechanical Power (in the form of angular speed and torque) dependeding on the degree of efficiency</td><td><a href=\"modelica://WaterPowerPlant.Components.Turbines.Turbine_advanced\">WaterPowerPlant.Components.Turbines.Turbine_advanced</a></td></tr><tr><td><b>Turbine_Pelton</b></td><td>FluidPort,&nbsp;RotationalPort</td><td>Showcase of a Pelton turbine. Transforming Pressure and Massflow to mechanical Power (in the form of angular speed and torque). It is dependeding on various input parameters.</td><td><a href=\"modelica://WaterPowerPlant.Components.Turbines.Turbine_Pelton\">WaterPowerPlant.Components.Turbines.Turbine_Pelton</a></td></tr><tr><td><b>Turbine_Francis</b></td><td>FluidPort,&nbsp;RotationalPort</td><td>Showcase of a Francis turbine. Transforming Pressure and Massflow to mechanical Power (in the form of angular speed and torque). It is dependeding on various input parameters.</td><td><a href=\"modelica://WaterPowerPlant.Components.Turbines.Turbine_Francis\">WaterPowerPlant.Components.Turbines.Turbine_Francis</a></td></tr></tbody></table></div></div></body></html>"));
    end Turbines;
    ...
    package Generators
      model Generator_basic
        ...
        parameter Modelica.Units.SI.Voltage U0 = 230 "Nom. voltage of the power grid";
        // Variables
  ...
  // electr. power output
  // electricalPort_out
        electricalPort_out.i = P_el/U0;
        electricalPort_out.v = U0;
        annotation(
          ...
          Documentation(info = "<html><head></head><body>Generator model taking into account the degree of efficiency.<div>Transforms the torque and angular speed into electrical power.</div><div><br></div><div>The basic generator is a simple Model of an generator transforming incoming torque and applied angular velocity into electrical power.<div>It provides one RotationalPort and one ElectricalPort connector.</div><div>The current of the ElectricalPort is calculated via a fixed voltage parameter.</div><div><div>Possible&nbsp;<b>Parameters</b>&nbsp;influencing the behavior are:</div><div><ul><li>eta as degree of efficiency (between 0 and 1)</li><li>U0 as the desired Voltage (e.g. the nominal Voltage of a power grid the generator should power)</li></ul></div></div></div></body></html>"));
      end Generator_basic;
      ...
      model Generator_Synchron
        ...
        parameter Modelica.Units.SI.Resistance R_e = 0.8 "Internal Resistances";
  ...
  //-theta = rotationalPort_in.M / (2 * M_break / Modelica.Constants.pi);
        ...
        annotation(
          ...
          Documentation(info = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Generator model taking into account the reactance of the machine, internal resistances, the power factor cos(phi) and the pole wheel angle.</span><div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><br></div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">The Synchron generator is a Model of an ac generator transforming incoming torque and applied angular velocity into electrical power.</div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">It uses the RMS representation of internal and external variables for calculation.</div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">The calculation has been done on the basis of to Förster, Wolfgang 2020 \"Elektrische Antriebssysteme und Aktorik\".</div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><div>It provides one RotationalPort and one ElectricalPort connector.</div><div>The nominal current of the ElectricalPort is calculated via a fixed nominal voltage parameter.</div><div><div>Possible&nbsp;<b>Parameters</b>&nbsp;influencing the behavior are:</div><div><ul><li>f0 as the frequency of the power grid</li><li>U0 as the desired nominal Voltage (e.g. the nominal Voltage of a power grid the generator should power)</li><li>X_d as the Reactance of the machine</li><li>R_e as different internal Resistances of the machine</li><li>cos_phi as cos(phi) the power factor of the machine</li><li>theta as the pole wheel angle. The pole wheel angle describes the working mode of the machine (-pi/2 to pi/2). A negative theta is synonymous to generator mode.</li></ul><div>Known issues: calculation of reactive power.</div></div></div></div></div></body></html>"));
  ...
  //working frequency of machine is the same as frequency of rotational input
        ...
        annotation(
          ...
          Documentation(info = "<html><head></head><body><span style=\"font-size: 12px; font-family: 'MS Shell Dlg 2';\">Generator model taking into account the reactance of the machine, internal resistances, the power factor cos(phi) and the pole wheel angle.</span><div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><br></div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">The Synchron generator 3Phases is a Model of an AC generator transforming incoming torque and applied angular velocity into electrical power.</div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><br></div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">It uses the complex representation of internal and external variables for calculation of time dependent and phase correct outputs.</div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">The calculation has been done on the basis of to Förster, Wolfgang 2020 \"Elektrische Antriebssysteme und Aktorik\".</div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><div>It provides one RotationalPort and three ElectricalPort connectors for a three phase alternating current power grid.</div><div>The current of the ElectricalPort is calculated via the alternating voltage. The real power is presented as nominal power.</div><div><div>Possible&nbsp;<b>Parameters</b>&nbsp;influencing the behavior are:</div><div><ul><li>f0 as the frequency of the power grid</li><li>U0 as the desired nominal Voltage (e.g. the nominal Voltage of a power grid the generator should power)</li><li>X_d as the Reactance of the machine</li><li>R_e as different internal Resistances of the machine</li><li>cos_phi as cos(phi) the power factor of the machine</li><li>theta as the pole wheel angle. The pole wheel angle describes the working mode of the machine (-pi/2 to pi/2). A negative theta is synonymous to generator mode</li></ul><div>Known issues: calculation of alternating power, calculation of reactive power.</div></div></div></div></div></body></html>"));
      end Generator_Synchron_3Phases;
      ...
      model Generator_dc
        ...
        parameter Modelica.Units.SI.Voltage U0 = 230 "voltage of the power grid";
        // Variables
        Modelica.Units.SI.Power P_el;
        Modelica.Units.SI.Current I_a, I_e;
        Real n;
      equation
        n = rotationalPort_in.omega/(2*Modelica.Constants.pi);
        P_el = U0*(I_a - I_e);
        I_e = U0/R_e;
        U0 = R_a*I_a + c1*n*psi + I_a*(R_w + R_k);
        electricalPort_out.i = I_a - I_e;
        electricalPort_out.v = U0;
        annotation(
          ...
          Documentation(info = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Generator model taking into account machine dependent constants, fix magnetic flux and different resistors in different parts of the dc machine.</span><div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><br></div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">DC generator is a Model of an dc generator transforming incoming torque and applied angular velocity into electrical power.</div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Specifically it represents a dc shunt engine, but with correct parameters it could be used as other dc machines as well.</div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">The calculation has been done on the basis of to Förster, Wolfgang 2020 \"Elektrische Antriebssysteme und Aktorik\".</div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><div>It provides one RotationalPort and one ElectricalPort connector.</div><div>The current of the ElectricalPort is calculated via a fixed voltage parameter.</div><div><div>Possible&nbsp;<b>Parameters</b>&nbsp;influencing the behavior are:</div><div><ul><li>c1 as Machine dependent constant 1 (regarding ratio between torque and current)</li><li>c2 as&nbsp;Machine dependent constant 2 (regarding ratio between rotational speed and voltage)</li><li>psi as constant magnetic flux</li><li>R_a as Resistance of the anchor of the machine</li><li>R_e as Resistance of the exciter of the machine (in this model, the exciter is in parallel to anchor etc.)</li><li>R_w as Resistance of the inverting poles of the machine</li><li>R_k as Resistance of the compensation windings of the machine</li><li>U0 as the desired Voltage (e.g. the dc Voltage of a power grid the generator should power)</li></ul></div></div></div></div></body></html>"));
      end Generator_dc;
      annotation(
        ...
        Documentation(info = "<html><head></head><body><div><b>Waterplant.Components.'Generators'</b></div>This Sublibrary contains the different Generators which have been modeled for various usecases:<div><br><div><table border=\"1\" cellspacing=\"0\" cellpadding=\"1\"><tbody><tr><td><strong>Name</strong></td><td><b>Connector</b></td><td><b>Usecase</b></td><td><strong>Link</strong></td></tr><tr><td><strong>Generator_basic<br></strong></td><td>ElectricalPort<br>RotationalPort</td><td>Showcase of transformation of angular speed and torque to electrical Power&nbsp;(in the form of voltage and current)(in the form of voltage and current) dependeding on the degree of efficiency</td><td><a href=\"modelica://WaterPowerPlant.Components.Generators.Generator_basic\">WaterPowerPlant.Components.Generators.Generator_basic</a></td></tr><tr><td><b>Generator_Synchron</b></td><td>ElectricalPort<br>RotationalPort</td><td>Showcase of a synchron machine as generator as it is commonly used in powerplants. Transforms angular speed and torque to electrical Power (in the form of voltage and current) dependeding on various input parameters. Uses the RMS representation of internal and external variables for calculation.</td><td><a href=\"modelica://WaterPowerPlant.Components.Generators.Generator_Synchron\">WaterPowerPlant.Components.Generators.Generator_Synchron</a></td></tr><tr><td><b>Generator_Synchron_3Phases</b></td><td>ElectricalPort<br>RotationalPort</td><td>Showcase of a synchron machine as generator as it is commonly used in powerplants. Transforms angular speed and torque to electrical Power (in the form of voltage and current) dependeding on various input parameters. Uses the the complex representation of internal and external variables for calculation of time dependent and phase correct outputs.</td><td><a href=\"modelica://WaterPowerPlant.Components.Generators.Generator_Synchron_3Phases\">WaterPowerPlant.Components.Generators.Generator_Synchron_3Phases</a></td></tr><tr><td><b>Generator_dc</b></td><td>ElectricalPort<br>RotationalPort</td><td>Showcase of a dc machine as generator as a dc shunt engine. Transforms angular speed and torque to electrical Power (in the form of voltage and current) dependeding on various input parameters.</td><td><a href=\"modelica://WaterPowerPlant.Components.Generators.Generator_dc\">WaterPowerPlant.Components.Generators.Generator_dc</a></td></tr></tbody></table></div></div></body></html>"));
    end Generators;
    ...
    equation
      ...
      annotation(
        ...
        Documentation(info = "<html><head></head><body>The Electrical Load is a simple Model of an electric consumer transforming incoming current and applied voltage into used power.<div>It provides the needed connection for the output of the 'Generator' Models of this library.</div><div>Due to the fact that the amplitude and the shape of the voltage vary greatly between each generator type and instance, this model has no internal reference voltage.&nbsp;</div><div>This model uses only the incoming variables of the electrical input and is thus underdetermined by itself. It has been developed with the connection to the Generator models in mind, which provide the necessary variables.<br><div>Possible&nbsp;<b>Parameters</b>&nbsp;influencing the resulting power are:</div><div><ul><li>eta as degree of efficiency (between 0 and 1)</li></ul></div></div></body></html>"));
    end ElectricalLoad;
  ...
  annotation(
    ...
    Documentation(info = "<html><head></head><body>A library for simulating a water power plant.&nbsp;</body></html>"));
end WaterPowerPlant;
